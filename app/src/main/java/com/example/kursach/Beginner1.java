...
public class Beginner1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginner_1);
    ...
    public  void set_upr_beginner_1() {
        if (gender_check.equals("Мужской")) {
            if (train_check == "КОМПЛЕКСНАЯ ТРЕНИРОВКА ВСЕГО ТЕЛА") {
                ...
                textView_how_much_1.setText(R.string.how_much_1);
                // второе упражнение
                ...
                textView_how_much_2.setText(R.string.how_much_2);
                ...
                textView_how_much_3.setText(R.string.how_much_3);
                ...
                textView_how_much_4.setText(R.string.how_much_4);
                ...
                textView_how_much_5.setText(R.string.how_much_5);
            ...
            if (train_check == "ТРЕНИРОВКА ВЕРХНЕЙ ЧАСТИ ТЕЛА") {
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_5);
                ...
                TextView textView_how_much_3 = findViewById(R.id.how_much_text_3);
                textView_how_much_3.setText(R.string.how_much_5);
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_3);
            ...
            if (train_check == "ТРЕНИРОВКА ТОРСА") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_5);
                // второе упражнение
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_5);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_6);
            ...
            if (train_check == "ТРЕНИРОВКА СПИНЫ") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_2);
                // второе упражнение
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_3);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_3);
