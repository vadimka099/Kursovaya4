...
public class MainMenuMale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_menu_male);

    }

    public void complex_click_male(View view) {
        your_train = "КОМПЛЕКСНАЯ ТРЕНИРОВКА ВСЕГО ТЕЛА";
        Person.setWorkout_value(your_train);

        Intent intent_comlex_male_click = new Intent(this, YourLevel.class);
        startActivity(intent_comlex_male_click);
    }
    public void top_click_male(View view) {
        your_train = "ТРЕНИРОВКА ВЕРХНЕЙ ЧАСТИ ТЕЛА";
        Person.setWorkout_value(your_train);

        Intent intent_click_male = new Intent(this, YourLevel.class);
        startActivity(intent_click_male);
    }
    public void tors_click_male(View view) {
        your_train = "ТРЕНИРОВКА ТОРСА";
        Person.setWorkout_value(your_train);

        Intent intent_tors_click_male = new Intent(this, YourLevel.class);
        startActivity(intent_tors_click_male);
    }
    public void spina_click_male(View view) {
        your_train = "ТРЕНИРОВКА СПИНЫ";
        Person.setWorkout_value(your_train);

        Intent intent_spina_click_male = new Intent(this, YourLevel.class);
        startActivity(intent_spina_click_male);
    }
    public void legs_click_male(View view) {
        your_train = "ТРЕНИРОВКА НИЖНЕЙ ЧАСТИ ТЕЛА";
        Person.setWorkout_value(your_train);

        Intent intent_legs_click_male = new Intent(this, YourLevel.class);
        startActivity(intent_legs_click_male);
    }
