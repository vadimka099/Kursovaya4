...
public class Professional2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_2);

        gender_check = Person.getGender_value();
        train_check = Person.getWorkout_value();


        set_upr_professional_2();
    }

    public void set_upr_professional_2() {
        if (gender_check.equals("Мужской")) {
            if (train_check == "КОМПЛЕКСНАЯ ТРЕНИРОВКА ВСЕГО ТЕЛА") {
                ...
                textView_how_much_1.setText(R.string.how_much_1_n_ns);
                // второе упражнение
                ...
                textView_how_much_2.setText(R.string.how_much_2_n_ns);
                ...
                textView_how_much_3.setText(R.string.how_much_3_n_ns);
                ...
                textView_how_much_4.setText(R.string.how_much_4_n_ns);
                ...
                textView_how_much_5.setText(R.string.how_much_5_n_ns);
                ...
                textView_how_much_6.setText(R.string.how_much_2_n_ns);

                TextView textview_6 = findViewById(R.id.upr_6_text);
                textview_6.setText(R.string.text_2_n);
                //седьмое упражнение

                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.zhym_g_leja);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_3_n_ns);

                TextView textview_7 = findViewById(R.id.upr_7_text);
                textview_7.setText(R.string.text_2_n);
            ...
            if (train_check == "ТРЕНИРОВКА ВЕРХНЕЙ ЧАСТИ ТЕЛА") {
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_5_n_ns);
                ...
                TextView textView_how_much_3 = findViewById(R.id.how_much_text_3);
                textView_how_much_3.setText(R.string.how_much_5_n_ns);
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_3_n_ns);
                ...
                ImageView imageView_4 = findViewById(R.id.upr_5);
                imageView_4.setImageResource(R.drawable.zhym_g_leja);

                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_3_n_ns);

                TextView textview_5 = findViewById(R.id.upr_5_text);
                textview_5.setText(R.string.text_2_n);
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_1_n_ns);

                TextView textview_6 = findViewById(R.id.upr_6_text);
                textview_6.setText(R.string.text_5_n);

                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.razgibaniya_na_triceps_v_trenazhere);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_5_n_ns);

                TextView textview_7 = findViewById(R.id.upr_7_text);
                textview_7.setText(R.string.text_9);
            ...
            if (train_check == "ТРЕНИРОВКА ТОРСА") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_5_n_ns);
                // второе упражнение
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_5_n_ns);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_6_n_ns);
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.planka_kolen);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_6_n_ns);

                TextView textview_7 = findViewById(R.id.upr_7_text);
                textview_7.setText(R.string.text_21);
            ...
            if (train_check == "ТРЕНИРОВКА СПИНЫ") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_2_n_ns);
                // второе упражнение
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_3_n_ns);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_4_n_ns);
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_4_n_ns);
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.tyaga_t);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_3_n_ns);

                TextView textview_7 = findViewById(R.id.upr_7_text);
                textview_7.setText(R.string.text_8_n);
            }
            if (train_check == "ТРЕНИРОВКА НИЖНЕЙ ЧАСТИ ТЕЛА") {
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_3_n_ns);
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.svedeneiye);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_3_n_ns);

                TextView textview_7 = findViewById(R.id.upr_7_text);
                textview_7.setText(R.string.text_9_n);
            }
        }
            ...
            if (train_check == "КОМПЛЕКСНАЯ ТРЕНИРОВКА ВСЕГО ТЕЛА") {
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.jim_gant_leja_fem);

                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_5_n_n);
            ...
            if (train_check == "ТРЕНИРОВКА ВЕРХНЕЙ ЧАСТИ ТЕЛА") {
                ...
                ImageView imageView_4 = findViewById(R.id.upr_5);
                imageView_4.setImageResource(R.drawable.jim_gant_leja_fem);

                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_6_n_n);
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.triceps_cross_fem);
            ...
            if (train_check == "ТРЕНИРОВКА ТОРСА") {
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.planka_kolen_fem);
            ...
            if (train_check == "ТРЕНИРОВКА СПИНЫ") {
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.t_grif);
            ...
            if (train_check == "ТРЕНИРОВКА НИЖНЕЙ ЧАСТИ ТЕЛА") {
                ...
                ImageView imageView_7 = findViewById(R.id.upr_7);
                imageView_7.setImageResource(R.drawable.razved_fem);
