...
public class Professional_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_1);

        gender_check = Person.getGender_value();
        train_check = Person.getWorkout_value();

        set_upr_professional_1();

    }

    public void set_upr_professional_1() {
        if (gender_check.equals("Мужской")) {
            if (train_check == "КОМПЛЕКСНАЯ ТРЕНИРОВКА ВСЕГО ТЕЛА") {
                ...
                textView_how_much_1.setText(R.string.how_much_1_n_n);
                // второе упражнение
                ...
                textView_how_much_2.setText(R.string.how_much_2_n_n);
                ...
                textView_how_much_3.setText(R.string.how_much_3_n_n);
                ...
                textView_how_much_4.setText(R.string.how_much_4_n_n);
                ...
                textView_how_much_5.setText(R.string.how_much_5_n_n);
                ...
                textView_how_much_6.setText(R.string.how_much_2_n_n);
                ...
                textView_how_much_7.setText(R.string.how_much_3_n_n);
            ...
            if (train_check == "ТРЕНИРОВКА ВЕРХНЕЙ ЧАСТИ ТЕЛА") {
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_5_n_n);
                ...
                TextView textView_how_much_3 = findViewById(R.id.how_much_text_3);
                textView_how_much_3.setText(R.string.how_much_5_n_n);
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_3_n_n);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_3_n_n);
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_1_n_n);
            ...
            if (train_check == "ТРЕНИРОВКА ТОРСА") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_5_n_n);
                // второе упражнение
                ...
                TextView textView_how_much_4 = findViewById(R.id.how_much_text_4);
                textView_how_much_4.setText(R.string.how_much_5_n_n);
                ...
                TextView textView_how_much_7 = findViewById(R.id.how_much_text_7);
                textView_how_much_7.setText(R.string.how_much_6_n_n);
            ...
            if (train_check == "ТРЕНИРОВКА СПИНЫ") {
                ...
                TextView textView_how_much_1 = findViewById(R.id.how_much_text_1);
                textView_how_much_1.setText(R.string.how_much_2_n_n);
                // второе упражнение
                ...
                TextView textView_how_much_2 = findViewById(R.id.how_much_text_2);
                textView_how_much_2.setText(R.string.how_much_3_n_n);
                ...
                TextView textView_how_much_5 = findViewById(R.id.how_much_text_5);
                textView_how_much_5.setText(R.string.how_much_4_n_n);
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_4_n_n);
            ...
            if (train_check == "ТРЕНИРОВКА НИЖНЕЙ ЧАСТИ ТЕЛА") {
                ...
                TextView textView_how_much_6 = findViewById(R.id.how_much_text_6);
                textView_how_much_6.setText(R.string.how_much_3_n_n);
